...
%   Start of 3.1 introducing channels

%   LIVELOCK-FREEDOM - change to no divergence before first lock
...
%   \item End of lit review
%   \item Diagrams
%   \item Standard notions
% \end{itemize}
\pagebreak
 \input{intro.tex}
 \input{lit.tex}
